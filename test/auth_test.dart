...
void main() {
  group("Mock Authentication", (){
    ...
    test("User should be nul after initialization", (){
    ...
    test("Create user should delegate to logIn functiona", () async{
      final badEmailUser = provider.createUser(email: "mo@bar.com",
       password: "anupassword");
       expect(badEmailUser,
       throwsA(const TypeMatcher<UserNotFoundAuthException>())
       );

       final badPasswordUser = provider.createUser(email: "someone@gmail.com",
        password: "123");
...
class MockAuthProvider implements AuthProvider{
  ...
  Future<AuthUser> logIn({required String email, required String password}) {
    if(!isInitialized) throw NotInitializedException();
    if(email == "mo@bar.com") throw UserNotFoundAuthException();
